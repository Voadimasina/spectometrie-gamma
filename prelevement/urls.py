...
urlpatterns = [
    ...
    path('api', PrelevementListCreateView.as_view(), name='prelevement-list-create'),
    path('api/<int:pk>', PrelevementRetrieveUpdateDestroyView.as_view(), name='prelevement-retrieve-update-destroy'),
]
